...
public class ExcelUtil {
    ...
    public static boolean generateWorkbook(String path, String name, String style, List<String> titles, List<Map<String, Object>> values) {
        ...
        for (Map<String, Object> value : values) {
            ...
            cell0.setCellValue(value.get("name") + "");

            Cell cell1 = row.createCell(1);
            cell1.setCellStyle(styles.get("cell"));
            cell1.setCellValue(value.get("searchName") + "");

            Cell cell2 = row.createCell(2);
            cell2.setCellStyle(styles.get("cell"));
            cell2.setCellValue(value.get("address") + "");

            Cell cell3 = row.createCell(3);
            cell3.setCellStyle(styles.get("cell"));
            cell3.setCellValue(value.get("addressDetail") + "");
